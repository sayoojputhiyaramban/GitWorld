...
<html>
	<head>
		<script>
			function hist()
			{
				window.location = "http://localhost/acProduct.php";
			}
		</script>
		<style>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tabs1-pane1">
						<form class="form-inline" role="form" method="post" action="export.php" enctype="multipart/form-data">
							...
							<div class="form-group">
								<div class="col-sm-6">
									<input class="btn btn-success btn-large"  type="submit" value="Submit" onsubmit="return validateField()" name="submit" id="submit"/>
								</div>
								</div>
						</form>	
