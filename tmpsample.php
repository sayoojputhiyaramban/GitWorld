  ...
  <div class="columns large-12">
    <div class="row wrapper">
      <div class="columns large-7 content">
        <h1 class="page-title">Akshaya sahayi</h1>
        <div>
        ...
        <ul class="row">
          ...
          <li class="columns large-4 about-list">
            <div class="img-wrapper">
              <!--<p><img src="../Traveler/Photos/" alt="" class="th about-image" style="height:200px; width:170px"> -->
            </div>
            </p>
            <h3 class="employer-name"></h3>
            <p><br>
			<br>
...
<div class="credit-row">
  <div class="row">
    <div class="columns large-11 credit">  <a href="#"></a> <a href="http://topwebsitetemplates.org"></a></div>
